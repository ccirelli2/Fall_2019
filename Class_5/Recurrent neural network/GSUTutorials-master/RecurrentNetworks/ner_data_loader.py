...
"""
def load_data(filename, min_length = -1, max_length = 10000000, keep_top = 20000):
...
def get_dictionaries(sentences, sentence_labels):
    ...
    ind_to_label = {ind:label for label,ind in label_to_ind.items()};
